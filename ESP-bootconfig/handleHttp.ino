...
void handleRoot() {
  ...
  server.sendContent(
    "<p>Look at these cool stuff, you can  <a href='/update'>update on the air </a></p>"
  );
  server.sendContent(
...
const char* serverIndex = "<form method='POST' action='/updnow' enctype='multipart/form-data'><input type='file' name='updnow'><input type='submit' value='Update'></form>";
